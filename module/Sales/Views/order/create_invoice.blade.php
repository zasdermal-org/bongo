                    ...
                    <div class="flex-lg-auto min-w-lg-300px me-xl-10 me-lg-7">
                        ...
                        <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
                            ...
                            <div class="card-body p-10">
                                ...
                                <div class="mb-10">
                                    <!--begin::Label-->
                                    <label class="form-label fw-bolder fs-6 text-gray-700 required">Product Category</label>
                                    <!--end::Label-->
...
@push('scripts')
    <script>
                        ...
                        $.each(data.sale_points, function (key, sale_point) {
                            $('#sale_point_id').append(
                                '<option value="' + sale_point.id + '">'
                                    + sale_point.name + ' — ' + '(' + sale_point.code_number + ')' + ' — ' + '(' + sale_point.address + ')'
                                    + '</option>'
                            );
                        });
                    },
                    error: function (error) {
                        console.log('Error fetching sale point data:', error);
                    }
                });
            } 
        }
        ...
        function categoryName() {
            ...
            let action = "{{ route('stocks_by_category_name') }}" + '?category_name=' + encodeURIComponent(selectedCategory);
        ...
        function add_product() {
            ...
            var unit_price = selectedStockOption.data('unit_price');
            ...
            let order_total_amount = quantity * unit_price;
