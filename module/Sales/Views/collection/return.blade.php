        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="card">
                <div class="card-body p-12">
                    ...
                    {{-- FORM --}}
                    <form action="{{ route('collection.store_return_invoice') }}" method="POST" id="kt_invoice_form">
                        @csrf
                            ...
                            <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700">
                                ...
                                <tbody data-kt-items="body">
                                    <tr data-kt-item="row">
                                        ...
                                        <td>
                                            <input type="number" name="quantity[]" min="1" class="form-control form-control-solid qty no-spinner">
                                        </td>

                                        <td>
                                            <input type="number" name="price[]" step="any" class="form-control form-control-solid price text-end no-spinner">
                                        </td>
