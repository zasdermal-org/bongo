    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Sale Point</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" action="{{ route('store_salePoint') }}" id="kt_modal_add_permission_form" class="form">
                    @csrf
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::Select2-->
                        <select name="territory_id" data-dropdown-parent="#kt_modal_add_permission" class="form-select form-select-solid mb-2" data-control="select2">
