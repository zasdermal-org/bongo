                ...
                @if(collect($reportPermissions)->some(fn($p) => auth()->user()->hasPermission($p[0], $p[1], 'read')))
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(Route::is('report.*')) here show mb-1 @endif">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            {{-- @if(auth()->user()->hasPermission('report', 'sales', 'read')) --}}
                                <div class="menu-item">
                                    <a class="menu-link @if(Route::is('report.collections')) active @endif" href="{{ route('report.collections') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            {{-- @if(auth()->user()->hasPermission('report', 'sales', 'read')) --}}
                                <div class="menu-item">
                                    <a class="menu-link @if(Route::is('report.customer_sales')) active @endif" href="{{ route('report.customer_sales') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Customer Sales</span>
                                    </a>
                                </div>
                            {{-- @endif --}}
