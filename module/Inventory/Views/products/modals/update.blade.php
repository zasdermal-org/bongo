    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" id="kt_modal_update_product_form" class="form">
                    @csrf
                    <!--begin::Input group-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="updateProductForm(this)">
...
<script>
    function updateProductForm(button) {
        let form = $('#kt_modal_update_product_form');
