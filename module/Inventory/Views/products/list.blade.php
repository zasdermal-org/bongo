    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Modal - Update Products-->
                @include('Inventory::products.modals.update')
...
@push('scripts')
    <script>
        function product(id) {
            let url = "{{ route('catalog.product', ['id' => ':id']) }}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    const form = $('#kt_modal_update_product_form');

                    let url = "{{ route('catalog.update_product', ['id' => ':id']) }}";
